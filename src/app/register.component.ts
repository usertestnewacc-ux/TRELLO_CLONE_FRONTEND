  ...
  template: `
    <div class="auth-wrapper">
      <div class="auth-card animate-in">
        ...
        <h1 class="auth-title">Sign up for your account</h1>
        <p class="auth-subtitle">Create a Trello account to manage projects</p>
  ...
  async submit() {
    ...
    try {
      await this.auth.register(
        this.email.trim(),
        this.password,
        this.firstName.trim() || undefined,
        this.lastName.trim() || undefined
      );
